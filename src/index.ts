...
@customElement('sunsynk-power-flow-card2')
export class SunsynkPowerFlowCard extends LitElement {
  ...
  render() {
    ...
    const stateObj64 = this.hass.states[config.entities.inverter_voltage_L1] || { state: '' };
    const stateObj65 = this.hass.states[config.entities.grid_ct_power_L1] || { state: '' };
    const stateObj66 = this.hass.states[config.entities.inverter_current_L1] || { state: '' };
    const stateObj67 = this.hass.states[config.entities.day_inverter_export] || { state: '0' };
    const stateObj68 = this.hass.states[config.entities.day_inverter_import] || { state: '0' };
    ...
    let grid_power_L1 = (invert_grid === true) ? parseInt(stateObj65.state) * -1 : parseInt(stateObj65.state);
    ...
    let grid_power_L1_L2_position=(410-5*(numDigits(grid_power_L1) + numDigits(grid_power_L2)));
    ...
    // remuved line to if three_phase_light// mediana
    let inverter_voltage = ((parseFloat(stateObj64.state) + parseFloat(stateObj54.state) + parseFloat(stateObj55.state))/3).toFixed(1);
    let inverter_voltage_L2 = config.entities?.inverter_voltage_L2 ? (config.inverter.three_phase_full === true && config.cardstyle === 'lite' ? parseFloat(stateObj54.state).toFixed(0) : parseFloat(stateObj54.state).toFixed(1)) : '';
    let inverter_voltage_L3 = config.entities?.inverter_voltage_L3 ? (config.inverter.three_phase_full === true && config.cardstyle === 'lite' ? parseFloat(stateObj55.state).toFixed(0) : parseFloat(stateObj55.state).toFixed(1)) : '';
    //let inverter_current = config.entities?.inverter_current_164 ? (config.inverter.three_phase_full === true && config.cardstyle === 'full' ? parseFloat(stateObj7.state).toFixed(0) : parseFloat(stateObj7.state).toFixed(1)) : 0;
    let inverter_current = ((parseFloat(stateObj56.state) + parseFloat(stateObj57.state) + parseFloat(stateObj66.state))/3).toFixed(2);
    let inverter_current_L1 = config.entities?.inverter_current_L1 ? (config.inverter.three_phase_full === true && config.cardstyle === 'full' ? parseFloat(stateObj66.state).toFixed(0) : parseFloat(stateObj56.state).toFixed(1)) : '';
    let inverter_current_L2 = config.entities?.inverter_current_L2 ? (config.inverter.three_phase_full === true && config.cardstyle === 'full' ? parseFloat(stateObj56.state).toFixed(0) : parseFloat(stateObj56.state).toFixed(1)) : '';
    let inverter_current_L3 = config.entities?.inverter_current_L3 ? (config.inverter.three_phase_full === true && config.cardstyle === 'full' ? parseFloat(stateObj57.state).toFixed(0) : parseFloat(stateObj57.state).toFixed(1)) : '';
    let inverter_current_L1_L2_position=(170-5*(numDigits(inverter_current_L1) + numDigits(inverter_current_L1)));
    ...
    let inverter_voltage_L1 = config.entities?.inverter_voltage_L1 ? (config.inverter.three_phase_light === true && config.cardstyle === 'lite' ? parseFloat(stateObj64.state).toFixed(0) : parseFloat(stateObj64.state).toFixed(1)) : '';
    
    if (config.inverter.three_phase_light){
      // calculate mediana of voltage
      
    } else {
      let inverter_voltage_when_not_three = config.entities?.inverter_voltage_154 ? (config.inverter.three_phase_full === true && config.cardstyle === 'lite' ? parseFloat(stateObj5.state).toFixed(0) : parseFloat(stateObj5.state).toFixed(1)) : 0;
      ...
      return html`
        ...
        ${config.title ? html`<h1 style="text-align: center; color: ${config.title_colour || 'inherit'}; font-size: ${config.title_size || '32px'};">${config.title}</h1>` : ''}
          <svg viewBox="-0.5 -0.5 457 383" preserveAspectRatio="xMidYMid meet" height="${panel !== true ? `${height}` : '100%'}" width="100%" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1">
            ...
            <rect x="386" y="265" width="70" height="${config.inverter.three_phase_full === true ? '50' : '30'}" rx="${config.inverter.three_phase_full === true ? '7.5' : '4.5'}" ry="${config.inverter.three_phase_full === true ? '7.5' : '4.5'}" fill="none" stroke="${grid_colour}" pointer-events="all" />
            ...
            <text id="daily_grid_buy" x="${grid_show_noness === false ? '311' : '347'}" y="${grid_show_noness === false ? '368' : '243'}" class="st3 left-align" fill="${grid_showdailybuy !== true ? 'transparent' : `${grid_colour}`}" >${localize('common.daily_grid_buy')}</text>
            <text id="daily_grid_sell" x="${grid_show_noness === false ? '311' : '347'}" y="${grid_show_noness === false ? '337' : '212'}" class="st3 left-align" fill="${grid_showdailysell !== true ? 'transparent' : `${grid_colour}`}" >${localize('common.daily_grid_sell')}</text>
            ...
            <text id="load-power-3P" x="237" y="142" display="${config.inverter.three_phase_light === true && config.entities?.load_power_L1 ? '' : 'none'}" class="st3 left-align" fill="${load_colour}" > ${config.inverter.three_phase_light === true && config.entities?.load_power_L1 ? load_power_L1 : '0'} ${config.inverter.three_phase_light === true && config.entities?.load_power_L2 ? '| ' + load_power_L2 : ''} ${config.inverter.three_phase_light === true && config.entities?.load_power_L3 ? '| ' + load_power_L3 : ''} W</text>
            <text id="load-voltage-3P" x="237" y="230" display="${config.inverter.three_phase_light === true && config.entities?.inverter_voltage_L1 ? '' : 'none'}" class="st3 left-align" fill="${grid_colour}" > ${config.inverter.three_phase_light === true && config.entities?.inverter_voltage_L1 ? inverter_voltage_L1 : '0'} ${config.inverter.three_phase_light === true && config.entities?.inverter_voltage_L2 ? '| ' + inverter_voltage_L2 : ''} ${config.inverter.three_phase_light === true && config.entities?.inverter_voltage_L3 ? '| ' + inverter_voltage_L3 : ''} V</text>
            <text id="grid-power-3P" x="${grid_power_L1_L2_position}" y="260" display="${config.inverter.three_phase_light === true && config.entities?.grid_ct_power_L1 ? '' : 'none'}" class="st3 left-align" fill="${grid_colour}" > ${config.inverter.three_phase_light === true && config.entities?.grid_ct_power_L1 ? grid_power_L1 : '0'} ${config.inverter.three_phase_light === true && config.entities?.grid_ct_power_L2 ? '| ' + grid_power_L2 : ''} ${config.inverter.three_phase_light === true && config.entities?.grid_ct_power_L3 ? '| ' + grid_power_L3 : ''} W</text>
            <text id="inverter-current-3P" x="${inverter_current_L1_L2_position}" y="157" display="${config.inverter.three_phase_light === true && config.entities?.inverter_current_L1 ? '' : 'none'}" class="st3 left-align" fill="${inverter_colour}" > ${config.inverter.three_phase_light === true && config.entities?.inverter_current_L1 ? inverter_current_L1 : '0'} ${config.inverter.three_phase_light === true && config.entities?.inverter_current_L2 ? '| ' + inverter_current_L2 : ''} ${config.inverter.three_phase_light === true && config.entities?.inverter_current_L3 ? '| ' + inverter_current_L3 : ''} A</text>
            ...
            <path id="grid-line1" d="${config.inverter.three_phase_full === true ? 'M 421 315 L 421 337' : 'M 421 295 L 421 310.5'}" fill="none" stroke="${grid_colour}" stroke-width="1" stroke-miterlimit="10"  pointer-events="stroke"/>
            <circle id="grid-dot" cx="0" cy="0" r="3" fill="${grid_power < 0 || grid_power === 0 ? 'transparent' : `${grid_colour}`}">
            ...
            <a href="#" @click=${(e) => this.handlePopup(e, config.entities.grid_connected_status_194)}>
              <svg xmlns="http://www.w3.org/2000/svg" id="transmission_on" x="${config.inverter.three_phase_full === true ? '404' : '387'}" y="${config.inverter.three_phase_full === true ? '339' : '310'}" width="${config.inverter.three_phase_full === true ? '34' : '67'}" height="${config.inverter.three_phase_full === true ? '34' : '67'}" viewBox="0 0 24 24"><path class="${grid_status === 'off' || grid_status === '0' || grid_status === 'Off-Grid' ? 'st12' : ''}" fill="${grid_colour}" d="m8.28 5.45l-1.78-.9L7.76 2h8.47l1.27 2.55l-1.78.89L15 4H9l-.72 1.45M18.62 8h-4.53l-.79-3h-2.6l-.79 3H5.38L4.1 10.55l1.79.89l.73-1.44h10.76l.72 1.45l1.79-.89L18.62 8m-.85 14H15.7l-.24-.9L12 15.9l-3.47 5.2l-.23.9H6.23l2.89-11h2.07l-.36 1.35L12 14.1l1.16-1.75l-.35-1.35h2.07l2.89 11m-6.37-7l-.9-1.35l-1.18 4.48L11.4 15m3.28 3.12l-1.18-4.48l-.9 1.36l2.08 3.12Z"/></svg>
              <svg xmlns="http://www.w3.org/2000/svg" id="transmission_off" x="${config.inverter.three_phase_full === true ? '404' : '387'}" y="${config.inverter.three_phase_full === true ? '339' : '310'}" width="${config.inverter.three_phase_full === true ? '34' : '67'}" height="${config.inverter.three_phase_full === true ? '34' : '67'}" viewBox="0 0 24 24"><path class="${grid_status === 'on' || grid_status === '1' || grid_status === 'On-Grid' ? 'st12' : ''}" fill="${no_grid_colour}" d="M22.1 21.5L2.4 1.7L1.1 3l5 5h-.7l-1.3 2.5l1.8.9l.7-1.4h1.5l1 1l-2.9 11h2.1l.2-.9l3.5-5.2l3.5 5.2l.2.9h2.1l-.8-3.2l3.9 3.9l1.2-1.2M9.3 18.1l1.2-4.5l.9 1.3l-2.1 3.2m5.4 0L12.6 15l.2-.3l1.3 1.3l.6 2.1m-.5-7.1h.7l.2.9l-.9-.9m-.1-3h4.5l1.3 2.6l-1.8.9l-.7-1.5h-4.2l-3-3l.5-2h2.6l.8 3M8.4 5.2L6.9 3.7L7.8 2h8.5l1.3 2.5l-1.8.9L15 4H9l-.6 1.2Z"/></svg>
            </a>
            ...
            <a href="#" @click=${(e) => this.handlePopup(e, config.entities.day_grid_import_76)}>
              <text id="daily_grid_buy_value" x="${grid_show_noness === false ? '311' : '347'}" y="${grid_show_noness === false ? '354' : '229'}" class="st4 left-align" display="${grid_showdailybuy !== true ? 'none' : ''}" fill="${grid_colour}" >${isNaN(parseFloat(stateObj3.state)) ? '0' : `${parseFloat(stateObj3.state).toFixed(1)}`} kWh</text>
            </a>
            <a href="#" @click=${(e) => this.handlePopup(e, config.entities.day_grid_export_77)}>
              <text id="daily_grid_sell_value" x="${grid_show_noness === false ? '311' : '347'}" y="${grid_show_noness === false ? '323' : '199'}" class="st4 left-align" display="${grid_showdailysell !== true ? 'none' : ''}" fill="${grid_colour}" >${isNaN(parseFloat(stateObj33.state)) ? '0' : `${parseFloat(stateObj33.state).toFixed(1)}`} kWh</text>
            </a>
          ...
          : svg`<text id="non_ess_power" x="338" y="281.5" display="${grid_show_noness === false ? 'none' : ''}" class="${font !== true ? 'st14' : 'st4'} st8" fill="${grid_colour}">${config.grid.auto_scale === true ? `${convertValue(nonessential, round) || 0}` : `${nonessential || 0} W`}</text>`}
            <a href="#" @click=${(e) => this.handlePopup(e, config.entities.grid_ct_power_172)}>
              <text id="grid_ct_power_172" x="420" y="${config.inverter.three_phase_full === true ? '276' : '281.5'}" display="${config.entities.grid_ct_power_172 === 'none' ? 'none' : ''}" class="${font !== true ? 'st14' : 'st4'} st8" fill="${grid_colour}">${config.grid.auto_scale === true ? `${convertValue(grid_power, round) || 0}` : `${grid_power || 0} W`}</text>
            </a>
            <a href="#" @click=${(e) => this.handlePopup(e, config.entities.grid_ct_power_L2)}>
              <text id="grid_ct_power_L2" x="420" y="292" display="${config.inverter.three_phase_full === true  && config.entities?.grid_ct_power_L2 ? '' : 'none'}" class="${font !== true ? 'st14' : 'st4'} st8" fill="${grid_colour}">${config.grid.auto_scale === true ? `${convertValue(grid_power_L2, round) || 0}` : `${grid_power_L2 || 0} W`}</text>
            </a>
            <a href="#" @click=${(e) => this.handlePopup(e, config.entities.grid_ct_power_L3)}>
              <text id="grid_ct_power_L3" x="420" y="307" display="${config.inverter.three_phase_full === true  && config.entities?.grid_ct_power_L3 ? '' : 'none'}" class="${font !== true ? 'st14' : 'st4'} st8" fill="${grid_colour}">${config.grid.auto_scale === true ? `${convertValue(grid_power_L3, round) || 0}` : `${grid_power_L3 || 0} W`}</text>
            </a>
          ...
          ? svg`<a href="#" @click=${(e) => this.handlePopup(e, config.entities.energy_cost_buy)}>
              <text id="energy_cost" x="427" y="207"  class="st3 left-align" fill="${grid_colour}" display="${config.entities?.energy_cost_buy  ? '' : 'none'}" >${energy_cost} ${stateObj43.attributes.unit_of_measurement}</text>
                  </a>`
          : svg`<a href="#" @click=${(e) => this.handlePopup(e, config.entities.energy_cost_sell)}>
              <text id="energy_cost" x="427" y="247"  class="st3 left-align" fill="${grid_colour}" display="${config.entities?.energy_cost_sell ? '' : 'none'}" >${energy_cost} ${stateObj51.attributes.unit_of_measurement}</text>
                  </a>`}

            <a href="#" @click=${(e) => this.handlePopup(e, config.entities.inverter_voltage_154)}>
              <text id="inverter_voltage_154" x="270" y="${config.inverter.three_phase_full === true ? '164' : '170.4'}" display="${config.entities.inverter_voltage_154 === 'none' || !config.entities.inverter_voltage_154 ? 'none' : ''}" class="${font !== true ? 'st14' : 'st4'} st8" fill="${grid_colour}" >${inverter_voltage} V</text>
            </a>
            <a href="#" @click=${(e) => this.handlePopup(e, config.entities.inverter_voltage_L2)}>
              <text id="inverter_voltage_L2" x="270" y="177" display="${config.inverter.three_phase_full === true  && config.entities?.inverter_voltage_L2 ? '' : 'none'}" class="${font !== true ? 'st14' : 'st4'} st8" fill="${grid_colour}" >${inverter_voltage_L2} V</text>
            </a>
            <a href="#" @click=${(e) => this.handlePopup(e, config.entities.inverter_voltage_L3)}>
              <text id="inverter_voltage_L3" x="270" y="190" display="${config.inverter.three_phase_full === true  && config.entities?.inverter_voltage_L3 ? '' : 'none'}" class="${font !== true ? 'st14' : 'st4'} st8" fill="${grid_colour}" >${inverter_voltage_L3} V</text>
            </a>
            <a href="#" @click=${(e) => this.handlePopup(e, config.entities.load_frequency_192)}>
              <text id="load_frequency_192" x="270" y="${config.inverter.three_phase_full === true ? '203' : '189.5'}" display="${config.entities.load_frequency_192 === 'none' || !config.entities.load_frequency_192 ? 'none' : ''}" class="${font !== true ? 'st14' : 'st4'} st8" fill="${grid_colour}">${load_frequency} Hz</text>
            </a>
            <a href="#" @click=${(e) => this.handlePopup(e, config.entities.inverter_current_164)}>
              <text id="inverter_current_164" x="180.5" y="${config.inverter.three_phase_full === true ? '188' : '199'}" display="${config.entities.inverter_current_164 === 'none' || !config.entities.inverter_current_164 ? 'none' : ''}" class="${font !== true ? 'st14' : 'st4'} st8" fill="${inverter_colour}" > ${inverter_current} ${config.inverter.three_phase_full === true && config.entities?.inverter_current_L2 ? '| ' + inverter_current_L2 : ''} A</text>
            </a>
            <a href="#" @click=${(e) => this.handlePopup(e, config.entities.inverter_current_L3)}>
              <text id="inverter_current_L3" x="180.5" y="203" display="${config.inverter.three_phase_full === true  && config.entities?.inverter_current_L3 ? '' : 'none'}" class="${font !== true ? 'st14' : 'st4'} st8" fill="${inverter_colour}">${inverter_current_L3} A</text>
            </a>
            ...
            <a href="#" @click=${(e) => this.handlePopup(e, config.entities.inverter_power_175)}>
              <text id="inverter_power_175" x="180.5" y="${config.inverter.three_phase_full === true ? '174' : '178'}" display="${config.entities.inverter_power_175 === 'none' ? 'none' : ''}" class="${font !== true ? 'st14' : 'st4'} st8" fill="${inverter_colour}">${config.inverter.auto_scale === true ? `${convertValue(inverter_power_round, round) || 0}` : `${parseFloat(stateObj22.state).toFixed(0) || 0} W`}</text>
            </a>
            <a href="#" @click=${(e) => this.handlePopup(e, config.entities.grid_power_169)}>
              <text id="grid_power_169" x="270" y="${config.inverter.three_phase_full === true ? '216' : '209'}" display="${config.entities.grid_power_169 === 'none' ? 'none' : ''}" class="${font !== true ? 'st14' : 'st4'} st8" fill="${grid_colour}">${config.grid.auto_scale === true ? `${convertValue(grid_power_round, round) || 0}` : `${parseFloat(stateObj23.state).toFixed(0) || 0} W`}</text>
            </a>
      ...
      return html`
        ...
        ${config.title ? html`<h1 style="text-align: center; color: ${config.title_colour || 'inherit'}; font-size: ${config.title_size || '32px'};">${config.title}</h1>` : ''}
          <svg viewBox="-0.5 ${config.show_solar === false ? (additional_load !== 0 || config.show_battery === false ? 80 : 145.33) : -0.5} 483 ${config.show_solar === false ? (config.show_battery === true ? (additional_load !== 0 ? 350 : 270.67) : 270.67) : (config.show_battery === false ? (additional_load === 2 ? 350 : 300) : 406)}" preserveAspectRatio="xMidYMid meet" height="${panel === false ? `${config.show_solar === false && config.show_battery === false ? '270px' : config.show_solar === false ? (additional_load !== 0 ? '330px' : '246px') : config.show_solar === true && config.show_battery === false ? (additional_load === 2 ? '350px' : '300px') : `${height}`}` : `${config.show_solar === false ? '75%' : '100%'}`}" width="100%"  xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1">
            ...
            <rect x="103" y="${config.inverter.three_phase_full === true ? '193.5' : '203.5'}" width="70" height="${config.inverter.three_phase_full === true ? '50' : '30'}" rx="${config.inverter.three_phase_full === true ? '7.5' : '4.5'}" ry="${config.inverter.three_phase_full === true ? '7.5' : '4.5'}" fill="none" stroke="${grid_colour}" pointer-events="all"/>
            ...
            <text id="load-power-L1" x="375" y="241" display="${config.inverter.three_phase_light === true && config.entities?.load_power_L1 ? '' : 'none'}" class="st3 left-align" fill="${load_colour}" >${config.load.auto_scale === true ? `${convertValue(load_power_L1, round) || 0}` : `${load_power_L1 || ''} W`}</text>
            <text id="load-power-L2" x="375" y="254" display="${config.inverter.three_phase_light === true && config.entities?.load_power_L2 ? '' : 'none'}" class="st3 left-align" fill="${load_colour}" >${config.load.auto_scale === true ? `${convertValue(load_power_L2, round) || 0}` : `${load_power_L2 || ''} W`}</text>
            <text id="load-power-L3" x="375" y="267" display="${config.inverter.three_phase_light === true && config.entities?.load_power_L3 ? '' : 'none'}" class="st3 left-align" fill="${load_colour}" >${config.load.auto_scale === true ? `${convertValue(load_power_L3, round) || 0}` : `${load_power_L3 || ''} W`}</text>
            ...
            <a href="#" @click=${(e) => this.handlePopup(e, config.entities.inverter_current_164)}>
              <text id="inverter_current_164" x="270.2" y="180.4" display="${config.entities.inverter_current_164 === 'none' || !config.entities.inverter_current_164 ? 'none' : ''}" class="st3 left-align" fill="${inverter_colour}">${inverter_current} ${config.inverter.three_phase_full === true && config.entities?.inverter_current_L2 ? '| ' + inverter_current_L2 : ''} ${config.inverter.three_phase_full === true && config.entities?.inverter_current_L3 ? '| ' + inverter_current_L3 : ''} A</text>
            </a>
            <a href="#" @click=${(e) => this.handlePopup(e, config.entities.battery_voltage_183)}>
            ...
            <a href="#" @click=${(e) => this.handlePopup(e, config.entities.grid_ct_power_172)}>
              <text id="grid_ct_power_172" x="135" y="${config.inverter.three_phase_full === true ? '205.5' : '219.2'}" display="${config.entities.grid_ct_power_172 === 'none' ? 'none' : ''}" class="${font !== true ? 'st14' : 'st4'} st8" fill="${grid_colour}">${config.grid.auto_scale === true ? `${convertValue(grid_power, round) || 0}` : `${grid_power || 0} W`}</text>
            </a>
            <a href="#" @click=${(e) => this.handlePopup(e, config.entities.grid_ct_power_L2)}>
              <text id="grid_ct_power_L2" x="135" y="220" display="${config.inverter.three_phase_full === true  && config.entities?.grid_ct_power_L2 ? '' : 'none'}" class="${font !== true ? 'st14' : 'st4'} st8" fill="${grid_colour}">${config.grid.auto_scale === true ? `${convertValue(grid_power_L2, round) || 0}` : `${grid_power_L2 || 0} W`}</text>
            </a>
            <a href="#" @click=${(e) => this.handlePopup(e, config.entities.grid_ct_power_L3)}>
              <text id="grid_ct_power_L3" x="135" y="234.5" display="${config.inverter.three_phase_full === true  && config.entities?.grid_ct_power_L3 ? '' : 'none'}" class="${font !== true ? 'st14' : 'st4'} st8" fill="${grid_colour}">${config.grid.auto_scale === true ? `${convertValue(grid_power_L3, round) || 0}` : `${grid_power_L3 || 0} W`}</text>
            </a>
            <a href="#" @click=${(e) => this.handlePopup(e, config.entities.pv1_voltage_109)}>
            ...
            ${grid_power >= 0
          ? svg`<a href="#" @click=${(e) => this.handlePopup(e, config.entities.energy_cost_buy)}>
              <text id="energy_cost" x="105" y="${config.inverter.three_phase_full === true ? '186' : '195'}" class="st3 left-align" fill="${grid_colour}" display="${config.entities?.energy_cost_buy ? '' : 'none'}" >${energy_cost} ${stateObj43.attributes.unit_of_measurement}</text>
                  </a>`
          : svg`<a href="#" @click=${(e) => this.handlePopup(e, config.entities.energy_cost_sell)}>
              <text id="energy_cost" x="105" y="${config.inverter.three_phase_full === true ? '186' : '195'}"  class="st3 left-align" fill="${grid_colour}" display="${config.entities?.energy_cost_sell ? '' : 'none'}" >${energy_cost} ${stateObj51.attributes.unit_of_measurement}</text>
                  </a>`}
            ${config.entities?.pv_total
          ? svg`<a href="#" @click=${(e) => this.handlePopup(e, config.entities.pv_total)}>
